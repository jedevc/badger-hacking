...
for input_filename in options.file:
    with Image.open(input_filename) as img:
        ...
        if options.binary:
            output_filename = options.out if options.out else input_filename.with_suffix(".raw")
            print(f"Saving to {output_filename}, {w}x{h}")
            with open(output_filename, "wb") as out:
                out.write(bytearray(output_data))
        elif options.py:
            output_filename = options.out if options.out else input_filename.with_suffix(".py")
            print(f"Saving to {output_filename}, {w}x{h}")
